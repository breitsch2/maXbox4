...
rtl.module("program",["System","JS","Web","Types","SysUtils","Math","ChartJS"],function () {
  ...
  $mod.$main = function () {
    ...
    document.getElementById("addDataset").addEventListener("click",function () {
      ...
      for (var $l = 0, $end = $mod.config.data.labels.length - 1; $l <= $end; $l++) {
        index = $l;
    ...
    document.getElementById("addData").addEventListener("click",function () {
      ...
      for (var $l = 0, $end = $mod.config.data.datasets.length - 1; $l <= $end; $l++) {
        index = $l;
    ...
    document.getElementById("removeData").addEventListener("click",function () {
      ...
      $mod.config.data.datasets.forEach(function (el, datasetIndex, arr) {
        var Result = false;
        $mod.config.data.datasets[datasetIndex].data.pop();
        Result = true;
        return Result;
      });
      $mod.chart.update();
