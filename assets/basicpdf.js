...
rtl.module("jsPDF",["System","JS","SysUtils"],function () {
  "use strict";
  var $mod = this;
});
rtl.module("program",["System","Web","jsPDF"],function () {
  "use strict";
  var $mod = this;
  this.doc = null;
  this.opt = "";
  this.edSelExample = null;
  this.btDownload = null;
  this.ebPreview = null;
  this.edSelExampleChange = function () {
    $mod.doc = new jsPDF();
    $mod.opt = $mod.edSelExample.value;
    var $tmp = $mod.opt;
    if ($tmp === "hello") {
      $mod.doc.text("Hello world. I love TjsPDF! :-)",10,10,undefined)}
     else if ($tmp === "font") {
      $mod.doc.text("This is the default font.",20,20,undefined);
      $mod.doc.setFont("courier");
      $mod.doc.setFontStyle("normal");
      $mod.doc.text("This is courier normal.",20,30,undefined);
      $mod.doc.setFont("times");
      $mod.doc.setFontStyle("italic");
      $mod.doc.text("This is times italic.",20,40,undefined);
      $mod.doc.setFont("helvetica");
      $mod.doc.setFontStyle("bold");
      $mod.doc.text("This is helvetica bold.",20,50,undefined);
      $mod.doc.setFont("courier");
      $mod.doc.setFontStyle("bolditalic");
      $mod.doc.text("This is courier bolditalic.",20,60,undefined);
      $mod.doc.setFont("times");
      $mod.doc.setFontStyle("normal");
      $mod.doc.text("This is centred text.",105,80,null,null,"center");
      $mod.doc.text("And a little bit more underneath it.",105,90,null,null,"center");
      $mod.doc.text("This is right aligned text",200,100,null,null,"right");
      $mod.doc.text("And some more",200,110,null,null,"right");
      $mod.doc.text("Back to left",20,120,undefined);
      $mod.doc.text("10 degrees rotated",20,140,null,10);
      $mod.doc.text("-10 degrees rotated",20,160,null,-10);
    } else if ($tmp === "two_page") {
      $mod.doc.text("Hello world!",20,20,undefined);
      $mod.doc.text("This is client-side Javascript, pumping out a PDF.",20,30,undefined);
      $mod.doc.addPage("l","a6");
      $mod.doc.text("Do you like that?",20,20,undefined);
    } else if ($tmp === "circles") {
      $mod.doc.ellipse(40,20,10,5,"S");
      $mod.doc.setFillColor(0,0,255,undefined);
      $mod.doc.ellipse(80,20,10,5,"F");
      $mod.doc.setLineWidth(1);
      $mod.doc.setDrawColor(0,undefined,undefined,undefined);
      $mod.doc.setFillColor(255,0,0,undefined);
      $mod.doc.circle(120,20,5,"FD");
    } else if ($tmp === "lines") {
      $mod.doc.line(20,20,60,20);
      $mod.doc.setLineWidth(0.5);
      $mod.doc.line(20,25,60,25);
      $mod.doc.setLineWidth(1);
      $mod.doc.line(20,30,60,30);
      $mod.doc.setLineWidth(1.5);
      $mod.doc.line(20,35,60,35);
      $mod.doc.setDrawColor(255,0,0,undefined);
      $mod.doc.setLineWidth(0.1);
      $mod.doc.line(100,20,100,60);
      $mod.doc.setLineWidth(0.5);
      $mod.doc.line(105,20,105,60);
      $mod.doc.setLineWidth(1);
      $mod.doc.line(110,20,110,60);
      $mod.doc.setLineWidth(1.5);
      $mod.doc.line(115,20,115,60);
    } else if ($tmp === "rectangles") {
      $mod.doc.rect(20,20,10,10,"S");
      $mod.doc.rect(40,20,10,10,"F");
      $mod.doc.setDrawColor(255,0,0,undefined);
      $mod.doc.rect(60,20,10,10,"S");
      $mod.doc.setDrawColor(255,0,0,undefined);
      $mod.doc.rect(80,20,10,10,"FD");
      $mod.doc.setDrawColor(0,undefined,undefined,undefined);
      $mod.doc.setFillColor(255,0,0,undefined);
      $mod.doc.rect(100,20,10,10,"F");
      $mod.doc.setDrawColor(0,undefined,undefined,undefined);
      $mod.doc.setFillColor(255,0,0,undefined);
      $mod.doc.rect(120,20,10,10,"FD");
      $mod.doc.setDrawColor(0,undefined,undefined,undefined);
      $mod.doc.setFillColor(255,255,255,undefined);
      $mod.doc.roundedRect(140,20,10,10,3,3,"FD");
    } else if ($tmp === "triangles") {
      $mod.doc.triangle(60,100,60,120,80,110,"FD");
      $mod.doc.setLineWidth(1);
      $mod.doc.setDrawColor(255,0,0,undefined);
      $mod.doc.setFillColor(0,0,255,undefined);
      $mod.doc.triangle(100,100,110,100,120,130,"FD");
    };
    $mod.ebPreview.src = $mod.doc.output("datauristring",null);
    $mod.btDownload.disabled = $mod.opt === "";
  };
  this.btDownloadClick = function () {
    $mod.doc.save($mod.opt + ".pdf",null);
  };
  $mod.$main = function () {
    $mod.edSelExample = document.getElementById("edSelExample");
    $mod.edSelExample.addEventListener("change",$mod.edSelExampleChange);
    $mod.btDownload = document.getElementById("btDownload");
    $mod.btDownload.addEventListener("click",$mod.btDownloadClick);
    $mod.ebPreview = document.getElementById("ebPreview");
  };
});
